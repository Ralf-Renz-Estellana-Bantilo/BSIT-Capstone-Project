			...
			<div className='outside-link-container'>
				...
				<div className='outside-link'>
					...
					<div className='outside-link-content'>
						<p>
							At Job Search Catarman, accessible from
							www.JobSearchCatarman.com, one of our main priorities is
							the privacy of our visitors. This Privacy Policy document
							contains types of information that is collected and
							recorded by Job Search Catarman and how we use it.
						</p>
						<p>
						...
						<p>
							...
							the information that they shared and/or collect in Job
							Search Catarman. This policy is not applicable to any
						...
						<h3>Log Files</h3>
						<p>
							Job Search Catarman follows a standard procedure of using
						...
						<p>
							...
							each of the advertising partners of Job Search Catarman.
						</p>
						<p>
							...
							Job Search Catarman, which are sent directly to users'
						...
						<p>
							Note that Job Search Catarman has no access to or control
							over these cookies that are used by third-party
							advertisers.
						</p>
						<h3>Third Party Privacy Policies</h3>
						<p>
							Job Search Catarman's Privacy Policy does not apply to
						...
						<p>
							...
							data disclose the categories and specific pieces of
							personal data that a business has collected about
							consumers.
						</p>
						<p>
						...
						<p>
							Job Search Catarman does not knowingly collect any Personal
