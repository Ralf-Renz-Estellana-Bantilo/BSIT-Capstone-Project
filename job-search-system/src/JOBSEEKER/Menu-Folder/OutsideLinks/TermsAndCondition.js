				...
				<div className='outside-link'>
					...
					<div className='outside-link-content'>
						<p style={{ textAlign: "center" }}>
							Welcome to Job Search Catarman!😊
						</p>

						<p>
							These terms and conditions outline the rules and
							regulations for the use of BSIT's Website, located at
							www.JobSearchCatarman.com.
						</p>

						<p>
							By accessing this website we assume you accept these terms
							and conditions. Do not continue to use Job Search Catarman
						...
						<p>
							We employ the use of cookies. By accessing Job Search
							Catarman, you agreed to use cookies in agreement with the
							BSIT's Privacy Policy.{" "}
						</p>
						...
						<p>
							Unless otherwise stated, BSIT and/or its licensors own the
							intellectual property rights for all material on Job Search
							Catarman. All intellectual property rights are reserved.
							You may access this from Job Search Catarman for your own
						...
						<p>You must not:</p>
						<ul>
							<li>Republish material from Job Search Catarman</li>
							<li>
								Sell, rent or sub-license material from Job Search
								Catarman
							</li>
							<li>
								Reproduce, duplicate or copy material from Job Search
								Catarman
							</li>
							<li>Redistribute content from Job Search Catarman</li>
						</ul>
						...
						<p>
							...
							post and exchange opinions and information in certain areas
							of the website. BSIT does not filter, edit, publish or
							review Comments prior to their presence on the website.
							Comments do not reflect the views and opinions of BSIT,its
							agents and/or affiliates. Comments reflect the views and
							opinions of the person who post their views and opinions.
							To the extent permitted by applicable laws, BSIT shall not
						...
						<p>
							BSIT reserves the right to monitor all Comments and to
						...
						<p>
							You hereby grant BSIT a non-exclusive license to use,
						...
						<p>
							...
							hyperlink compensates the absence of BSIT; and (d) the link
						...
						<p>
							...
							must inform us by sending an e-mail to BSIT. Please include
							your name, your organization name, contact information as
							well as the URL of your site, a list of any URLs from which
							you intend to link to our Website, and a list of the URLs
							on our site to which you would like to link. Wait 2-3 weeks
							for a response.
						</p>
						...
						<p>
							No use of BSIT's logo or other artwork will be allowed for
