		...
		<div className='outside-link'>
			...
			<div className='outside-link-content'>
				...
				<p>
					...
					the use of BSIT's Website, located at www.JobSearchCatarman.com.
				</p>

				<p>
					By accessing this website we assume you accept these terms and
					conditions. Do not continue to use Job Search Catarman if you do
				...
				<p>
					We employ the use of cookies. By accessing Job Search Catarman,
					you agreed to use cookies in agreement with the BSIT's Privacy
					Policy.{" "}
				</p>
				...
				<p>
					...
					Catarman. All intellectual property rights are reserved. You may
					access this from Job Search Catarman for your own personal use
				...
				<ul>
					...
					<li>
						Sell, rent or sub-license material from Job Search Catarman
					</li>
					<li>
						Reproduce, duplicate or copy material from Job Search Catarman
					</li>
				...
				<p>
					...
					website. BSIT does not filter, edit, publish or review Comments
					prior to their presence on the website. Comments do not reflect
					the views and opinions of BSIT,its agents and/or affiliates.
					...
					laws, BSIT shall not be liable for the Comments or for any
				...
				<p>
					BSIT reserves the right to monitor all Comments and to remove any
				...
				<p>
					You hereby grant BSIT a non-exclusive license to use, reproduce,
				...
				<p>
					...
					BSIT; and (d) the link is in the context of general resource
					information.
				</p>
				...
				<p>
					...
					by sending an e-mail to BSIT. Please include your name, your
