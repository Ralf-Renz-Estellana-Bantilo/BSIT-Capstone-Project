		...
		<div className='outside-link'>
			...
			<div className='outside-link-content'>
				<p>
					...
					www.JobSearchCatarman.com, one of our main priorities is the
					privacy of our visitors. This Privacy Policy document contains
					types of information that is collected and recorded by Job Search
					Catarman and how we use it.
				</p>
				<p>
				...
				<p>
					...
					that they shared and/or collect in Job Search Catarman. This
				...
				<h3>Log Files</h3>
				<p>
					Job Search Catarman follows a standard procedure of using log
				...
				<p>
					...
					the advertising partners of Job Search Catarman.
				</p>
				<p>
					Third-party ad servers or ad networks uses technologies like
					cookies, JavaScript, or Web Beacons that are used in their
					respective advertisements and links that appear on Job Search
					Catarman, which are sent directly to users' browser. They
				...
				<p>
					Note that Job Search Catarman has no access to or control over
					these cookies that are used by third-party advertisers.
				</p>
				<h3>Third Party Privacy Policies</h3>
				<p>
					Job Search Catarman's Privacy Policy does not apply to other
